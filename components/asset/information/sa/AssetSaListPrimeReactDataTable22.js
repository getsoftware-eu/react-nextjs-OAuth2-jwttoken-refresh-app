            ...
            <div className="row">
                <div className="col-auto">
                    ...
                    <InputText value={globalFilterValue} onChange={onGlobalFilterChange} type="search"
                               placeholder="Search..." style={{height: '32px'}}/>
                </div>
    ...
    return (
        <div className="card">
            <DataTable ref={dt} 
                ...
                <Column field="editorId" header="Bearbeiter" sortable body={editorBodyTemplate} showFilterMenu={false} filterMenuStyle={{ width: '14rem' }} style={{ height: '32px'}} filter filterElement={statusRowFilterTemplate} />
                <Column field="saStatus" header="Status" sortable body={saStatusBodyTemplate} showFilterMenu={false} filterMenuStyle={{ width: '14rem' }} style={{ height: '32px' }} filter filterElement={statusRowFilterTemplate} />
