...
function SearchedInformationCard({ information, favorited }) {
      ...
      >
        ...
        <div className="flex-grow p-6 space-y-1">
          ...
          <p className="text-gray-500 text-sm">
            {information.category.categoryName} · {information.capacity} guests
          </p>
        ...
        <div className="flex flex-col justify-between items-center py-6 px-12">
          ...
          <p className="text-lg font-semibold">{information.price}₺</p>
        </div>
      </div>
    </Link>
  );
...
export default SearchedInformationCard;
